...
- live routes: 95 · The command lattice stays tied to executable contracts.
- test functions: 55 · Proof is carried beside the operator surfaces, not after them.
- named models: 4 · Model count stays visible so command breadth does not drift into theater.
- audio manifests: 70 · Raw media stays external while the manifest and feature lane remain inspectable.
- music feature runs: 70 · Every speech-task card below is backed by the same derived warehouse lane.
